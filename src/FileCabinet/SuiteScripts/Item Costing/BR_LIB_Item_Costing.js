     ...
     */
        function itemInformationSearch(itemId){
            ...
            var itemFields = searchModule.create({
                ...
                columns:
                    [
                        searchModule.createColumn({name: 'itemid'}), //Item Name
            ...
            var itemName = parseFloat(itemFirstResult.getValue({name: 'itemid'}));
            ...
            var productStatus = itemFirstResult.getText({name: 'custitem_product_status'});
