...
var serverWidget, query, log, file;

define (['N/ui/serverWidget', 'N/query', 'N/log', 'N/runtime', 'N/file', 'N/email'], main);

function main (serverWidgetModule, queryModule, logModule, runtimeModule, fileModule, emailModule){
...
/*            var savedResults = fileModule.create({
            ...
            fileModule.folder = 92676;
            var fileId = savedResults.save();*/
log.audit({title: 'Prepare to email'});
            //TEST
        ...
        // call Client to send file to user
